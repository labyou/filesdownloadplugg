...
function upload(selector) {
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest('.preview_block');
  ...
  var uploadHandler = function uploadHandler() {
    preview.querySelectorAll('.preview_remove').forEach(function (e) {
      return e.remove();
    });
    var previewInfo = preview.querySelectorAll('.preview_info');
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        var block = blocks[index].querySelector('.preview_info_progress');
